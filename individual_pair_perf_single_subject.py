...
#segmentation_kd = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Individual Segmentation/Kaushik/maskBRATS_012.nii").get_fdata()[:,:,:,0]
segmentation_kd = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Individual Segmentation/Kaushik/maskBRATS_018.nii").get_fdata()[:,:,:,0]
segmentation_kd = 1.0*(segmentation_kd>0)

#segmentation_db = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Individual Segmentation/Danni/maskBRATS_012_DB.nii").get_fdata()[:,:,:,0]
segmentation_db = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Individual Segmentation/Danni/maskBRATS_018_DB.nii").get_fdata()[:,:,:,0]
segmentation_db = 1.0*(segmentation_db>0)

################ Read the Paired Masks ####################
#segmentation_pair = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Pair Segmentation/maskBRATS_012.nii").get_fdata()[:,:,:,0]
segmentation_pair = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Pair Segmentation/maskBRATS_018.nii").get_fdata()[:,:,:,0]
...
#ground_truth = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Individual Segmentation/BRATS_012.nii").get_fdata()[:,:,:]
ground_truth = nib.load("C:/Users/kaushik.dutta/Box/Brain Tumor Study/Individual Segmentation/BRATS_018.nii").get_fdata()[:,:,:]
