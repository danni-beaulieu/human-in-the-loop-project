...
plt.imshow(ground_truth_mask[6,130:200,65:135], cmap='Pastel1', interpolation='none')
plt.imshow(voting_output_mask[6,130:200,65:135], cmap='Blues', interpolation='none', alpha=0.25)
plt.imshow(staple_output_mask[6,130:200,65:135], cmap='Set3', interpolation='none', alpha=0.25)
